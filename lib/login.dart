...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text('Welcome to QuickTask - Log In',
              style: TextStyle(
                  fontSize: 20,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: const Text('Organize your tasks, empower your day',
                  style: TextStyle(
            ...
            TextButton(
              ...
              child: Text('Don’t have an account? Register here to begin!'),
            ),
          ],
        ),
      ),
      ...
      if (response.success) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            title: Text('Error'),
            content: Text('Login error: ${response.error!.message}'),
            actions: [
              TextButton(
