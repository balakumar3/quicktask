...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text('Welcome to QuickTask - Register',
              style: TextStyle(
                  fontSize: 20,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: const Text('Please provide your login details',
                  style: TextStyle(
  ...
  void doUserRegistration() async {
    ...
    if (response.success) {
      showSuccess("Congratulations! Registration was successful");
    } else {
